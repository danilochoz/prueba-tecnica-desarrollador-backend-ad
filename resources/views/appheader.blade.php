...
<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-light bg-secondary">
    <div class="container-fluid ">
        <button type="button" id="sidebarCollapse" class="sidebar-toggler btn btn-secondary mx-2">
        <span class="navbar-toggler-icon"></span>
        </button>
        <a class="navbar-brand" href="/home">
            <img class="img-responsive" src="{{ asset('images/logo.svg') }}" style="max-height: 50px !important;" />
            {{ config('app.name') }}
        </a>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        ...
                        <span>Hola <b><?php echo $user->UserName(); ?></b></span>
                    </a>
