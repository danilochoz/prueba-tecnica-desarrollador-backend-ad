            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("autores/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nombre_completo-holder" class=" ">
                                            <input id="ctrl-nombre_completo" data-field="nombre_completo"  value="<?php  echo $data['nombre_completo']; ?>" type="text" placeholder="Escribir Nombre completo"  required="" name="nombre_completo"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nacionalidad-holder" class=" ">
                                            <input id="ctrl-nacionalidad" data-field="nacionalidad"  value="<?php  echo $data['nacionalidad']; ?>" type="text" placeholder="Escribir Nacionalidad"  name="nacionalidad"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
