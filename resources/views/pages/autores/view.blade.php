                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="page-data">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <a class="btn btn-sm btn-success has-tooltip "   title="Editar" href="<?php print_link("autores/edit/$rec_id"); ?>" >
                                    <i class="material-icons">edit</i> Editar
                                </a>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal" title="Borrar" href="<?php print_link("autores/delete/$rec_id?redirect=autores"); ?>" >
